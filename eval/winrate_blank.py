...
file1_path = r"D:\CODE\three_0921\data\blank_unique.jsonl"
file2_path = r"D:\CODE\three_0921\eval\data\blank\merged_blank1_dedup.json"
...
out_put_win_rate = f"Win_Rate_ReACT_blank_{timestamp}_{model_name}.json"
with open(out_put_win_rate, "w", encoding="utf-8") as f:
    json.dump(final_output, f, ensure_ascii=False, indent=2)

# 单独保存失败题目 ID
failed_file = f"failed_questions_ReACT_blank_{timestamp}_{model_name}.json"
